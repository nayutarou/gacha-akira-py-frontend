...
const TestComponent = () => {
  const { gachaHistory, resultCounts, addGachaResult, resetGachaHistory } = useGacha();
  return (
    <div>
      ...
      <button onClick={resetGachaHistory}>Reset</button>
    </div>
  );
};
...
describe("GachaContext", () => {
  ...
  it("resets gacha history and counts", () => {
    render(
      <GachaProvider>
        <TestComponent />
      </GachaProvider>,
